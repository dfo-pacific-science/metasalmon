...
The shared reusable term IRIs themselves use the `salmon:` namespace
(for example `http://w3id.org/salmon/Stock`). You don’t need to
understand ontologies to use metasalmon - this is handled automatically
