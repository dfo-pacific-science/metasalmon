---
title: "AI Assistance for Salmon Data Packages"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{AI Assistance for Salmon Data Packages}
...
- [Data Dictionary & Publication](articles/data-dictionary-publication.html) for the metadata and publication workflow
- [Reusing Standards for Salmon Data Terms](articles/reusing-standards-salmon-data-terms.html) for the plain-language ontology guidance
...
This complements the GPT workflow by providing deterministic, reproducible suggestions that you can review and merge into your dictionary. See [Reusing Standards for Salmon Data Terms](articles/reusing-standards-salmon-data-terms.html) for details on `find_terms()` and the I-ADOPT catalogue.
