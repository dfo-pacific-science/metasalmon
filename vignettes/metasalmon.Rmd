...
If you want to automate that split+ask-and-render flow, use the new helper trio in the package:
...
For production use, run the last call with `dry_run = FALSE` once your payloads look right.
